...
/**
 * This widget renders all arrows and links that illustrate relations
 * between mindmap nodes.
 * @author dominik
 *
 */
@SuppressWarnings("deprecation")	// ClickListener is deprecated but I use a 3rd party
...
public class ArrowsWidget extends Composite implements ArrowMaker {
	...
	public static class Arrow {
		...
		public boolean equals(Object obj) {
			if (!(obj instanceof Arrow)) return false;
			Arrow a = (Arrow) obj;
	...
	protected void sendOnClick() {
		if(_mindMapWidget != null) _mindMapWidget.onClick();
	}
	...
	public void render() {
		...
		if(isAttached()) {
			...
			for(Arrow arrow:_arrowSet) {
				...
				fy += 8*sinAlpha/cosAlpha;
				fx += 8;
				ty -= 5*sinAlpha/cosAlpha;
				tx -= 5;
	...
	public void removeArrow(NodeWidget from, NodeWidget to) {
		...
		// we rely on the Set removing an object if it .equals() the passed parameter
